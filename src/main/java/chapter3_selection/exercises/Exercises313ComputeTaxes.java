...
public class Exercises313ComputeTaxes {
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);

        System.out.print("(0-single filter, 1-married jointly or " + " qualifying widow(er), 2-married separatly, 3-head of " + "houshold) Enter the filing  status: ");
        ...
        switch (status)
        {
            ...
            case 1 : // Compute tax  for married file joinly or qualifying widow(er)
                ...
                if (income > 208850)
                    tax += (income <= 372950) ? (income - 137050) * 0.28 : (208850 - 137050) * 0.28;
                if (income <= 208850)
            ...
            case 2 : // Compute tax for married sparately
                tax += (income <= 8350) ? income * 0.10 : 8350 * 0.10;
                if (income > 8350)
            ...
            case 3 : // Compute thw head of haousold
