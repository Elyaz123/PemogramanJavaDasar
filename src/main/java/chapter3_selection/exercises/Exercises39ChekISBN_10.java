...
public class Exercises39ChekISBN_10 {
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);

        //Prompt the user to enter the first 9 digits of a 10 digits ISBN
        ...
        //Display the 10- digits ISBN
        if (d10 == 10)
        {
            System.out.println("The ISBN-10 number is " + d1 + d2 + d3 + d4 + d5 + d6 + d7 + d7 + d8 + d9 + "X");
        }
        else
            System.out.println("The ISBN-10 number is " + d1 + d2 + d3 + d4 + d4 + d5 + d6 + d7 + d8 + d9 + d10);
    }
}
